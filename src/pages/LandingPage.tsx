      ...
      <header className="sticky top-0 z-30 border-b border-slate-200/80 bg-white/95 backdrop-blur">
        <nav className="mx-auto flex max-w-7xl items-center justify-between px-5 py-3 sm:px-8">
          ...
          <div className="flex items-center gap-2">
            <a
              href="/portal"
              className="rounded-md border border-slate-300 px-4 py-2 text-sm font-semibold text-[#00478d] transition hover:border-[#00478d] hover:bg-blue-50 focus:outline-none focus:ring-2 focus:ring-[#73d1ff] focus:ring-offset-2"
            >
              Ingreso
            </a>
            <a
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-10 px-5 py-12 sm:px-8 lg:grid-cols-[1fr_0.92fr] lg:py-16">
          <div className="max-w-2xl">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              ...
              <a
                href="#servicios"
                className="inline-flex items-center justify-center rounded-md border border-slate-300 px-5 py-3 text-sm font-semibold text-slate-700 transition hover:border-slate-500 hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-[#73d1ff] focus:ring-offset-2"
              >
                Ver servicios
              </a>
            </div>
